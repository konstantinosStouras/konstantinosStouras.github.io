...
set "WFS=lit-update-data.yml lit-check-new.yml lit-editors-backfill.yml lit-preprints-backfill.yml lit-citations-update.yml lit-ft50-update-data.yml lit-ft50-check-new.yml lit-ft50-preprints-backfill.yml lit-ft50-citations-update.yml lit-ft50-abstracts-backfill.yml lit-references-backfill.yml lit-workingpapers-backfill.yml lit-workingpapers-update-data.yml"
