...
import { invertedToText, mergeAbsCache, isNeedy, elsevierAbstract, springerAbstract, shouldStampMiss,
  ...
  readRateLimit, elsErrorText, isRecentYear, headerSafeValue, ELS_PREFIX, SPR_PREFIX, main } from './abstracts-ci.mjs';
import { betterAbstract } from '../_scraper/informs-abstracts.mjs';
import { readChunkedJsonSync } from '../_scraper/_chunked-json.mjs';
