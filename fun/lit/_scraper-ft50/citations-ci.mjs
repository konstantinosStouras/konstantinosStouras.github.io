/*
 * citations-ci.mjs — the ONLINE citation-count sweep for the FT50 catalog
 * (fun/lit/data-ft50/), run on GitHub Actions by
 * .github/workflows/lit-ft50-citations-update.yml (daily). Near-verbatim from
 * the reference fun/lit/_scraper/citations-ci.mjs — see its header for the
 * full design: a bounded oldest-check-first sweep of OpenAlex cited_by_count
 * (50 DOIs/call) + Semantic Scholar citationCount (500 DOIs/POST) into the
 * incremental data-ft50/_citations.json, then the cache is applied to the
 ...
 * (OpenAlex contact; the workflow pins its own quota identity),
