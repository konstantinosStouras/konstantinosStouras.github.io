/*
 * build-data.mjs — fun/lit's OWN FT50 pipeline (the lit merged catalog).
 * ===========================================================================
 * This is fun/lit's independent copy of the fun/ft50 data pipeline, vendored
 ...
 * REST API, and writes static JSON into fun/lit/data-ft50/, which GitHub
 ...
 *
 * What it writes into fun/lit/data-ft50/:
