/*
 * build-analytics.mjs — the summary-statistics pipeline for stouras.com/fun/lit/analytics/.
 * ===========================================================================
 * The analytics sub-page (fun/lit/analytics/) is an interactive dashboard, but
 ...
 *
 *   • fun/lit/analytics/data.json    — per-journal × per-year aggregates
 ...
 *   • fun/lit/analytics/authors.json — per-author aggregates (papers per year,
 ...
 *   • fun/lit/data/          (the eight native sources: MS, OpRe, MkSc, M&SOM,
 *                             ISR, POM, PNAS, ACM EC)
 *   • fun/lit/data-ft50/     (the FT50 catalog; its journals that duplicate a
 ...
 * are kept BYTE-FOR-BYTE in sync with fun/lit/index.html — if you change the
...
// ── Journal-type membership — mirror of fun/lit/index.html ──────────────────
