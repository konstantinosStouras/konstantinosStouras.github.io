/*
 * build-data.mjs — the fun/lit "Working Papers" archive pipeline.
 * ===========================================================================
 * Archives the UNPUBLISHED working papers / pre-prints (SSRN, NBER, arXiv,
 * OSF) of every author already listed in "The Lit" (stouras.com/fun/lit/),
 * and writes them as a static JSON dataset into fun/lit/data-workingpapers/,
