/* ==========================================================================
   Sustainable Supply Chains · admin/xlsx.js
   ...
   API (browser: window.SSCXlsx; Node: module.exports, used by tools/selftest.js):
     SSCXlsx.build(sheets) -> Uint8Array          // the .xlsx file bytes
     SSCXlsx.download(filename, sheets)           // browser: trigger a download
