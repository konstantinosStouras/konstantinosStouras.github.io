...
(function (root, factory) {
  ...
  var ROUNDS = {
    ...
    stop_rule: ['factor', 'How this session settles a round: best_found (stopping takes the best prize already found and never opens a new position) or nominate (the legacy rule \u2014 stopping names a position and pays the true prize there). Locked at launch; sessions stored before the parameter existed are nominate.'],
