...
(function () {
  ...
  var PF_DA_TPL_VERSION = '2026-07-08-within5-playbook';
  ...
  var DA_PY_TEMPLATE = [
    ...
    '  8. Twelve figures - shown in the \'Insights gained\' section, each under the',
    ...
    'fig.tight_layout()',
    '',
    '# Figure 5 - the greedy trap: $/cell of the bricks placed, covering EVERY',
    ...
    'fig.tight_layout()',
    '',
    '# Figure 9 - the two windows move by move: the opening aligned at move 1, the',
    ...
    '',
    'if ok7:',
    '    # Figure 10 - the heuristic profile as paired dots: each marker z-scored over',
    ...
    '    fig.tight_layout()',
    '',
    '    # Figure 11 - which habits pay: within-5% success rate among the players who',
    ...
    '    fig.tight_layout()',
    '',
    '    # Figure 12 - style vs outcome: one dot per player; x = how \'top-like\' their',
    ...
    'print("## Figure 9 - the two windows, move by move")',
    ...
    '              f"Section-7 table and Figure 11.")',
    '    if r_sc:',
    ...
    '              f"r = {r_sc[0]:.3f} (p = {p4(r_sc[1])}) - see Figure 12.")',
    ...
    'print("## Figure 10 - the heuristic profile at a glance")',
    ...
    'print("## Figure 11 - which habits pay")',
    ...
    'print("## Figure 12 - does playing \'top-like\' pay off?")',
  ...
  var DA_R_TEMPLATE = [
    ...
    '#             correlation, (8) twelve figures + a data-driven INSIGHTS',
    ...
    '}',
    'cat("## Figure 9 - the two windows, move by move\\n")',
    ...
    '  if (length(ranked) > 1) {',
    '    cat(sprintf("- THE HABITS THAT PAID MOST (success-rate lift when a player shares the top group\'s side of a habit): 1st %s (%s than the median): %.0f%% of sharers got within 5%% vs %.0f%% of the others (lift %+.0f points, p = %s); 2nd %s (%s): %.0f%% vs %.0f%% (lift %+.0f points, p = %s). The full ranking is the Section-7 table and Figure 11.\\n",',
    ...
    '  }',
    '  if (!is.null(r_sc)) {',
    '    cat(sprintf("- STYLE PAYS AS A PACKAGE: a one-number style score (all six habits, oriented towards the top group and averaged) correlates with a player\'s closest approach to the maximum at r = %.3f (p = %s) - see Figure 12.\\n", r_sc[1], p4(r_sc[2])))',
    '  }',
    ...
    '}',
    'cat("## Figure 10 - the heuristic profile at a glance\\n")',
    ...
    'cat("## Figure 11 - which habits pay\\n")',
    ...
    'cat("## Figure 12 - does playing \'top-like\' pay off?\\n")',
